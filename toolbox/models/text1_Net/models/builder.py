...
import toolbox.models.CMXNet.config
from toolbox.models.CMXNet.config import config
from toolbox.models.CMXNet.utils.init_func import init_weight
from toolbox.models.CMXNet.utils.load_utils import load_pretrain
from functools import partial

from toolbox.models.CMXNet.engine.logger import get_logger
...
class EncoderDecoder(nn.Module):
    def __init__(self, cfg=None, criterion=nn.CrossEntropyLoss(reduction='mean', ignore_index=255), norm_layer=nn.BatchNorm2d):
        ...
        # logger.info('Using backbone: swin-b')
        from toolbox.models.CMXNet.models.encoders.dual_segformer import mit_b2 as backbone
        # from toolbox.models.CMXNet.models.encoders.dual_swin import swin_b as backbone
        self.backbone = backbone(norm_fuse=norm_layer)
        ...
        from toolbox.models.CMXNet.models.decoders.MLPDecoder import DecoderHead
        self.decode_head = DecoderHead(in_channels=self.channels, num_classes=8, norm_layer=norm_layer, embed_dim=512)
...
if __name__ == "__main__":
    ...
    in_rgb = torch.randn(2, 3, 480, 640)
    in_depth = torch.randn(2, 3, 480, 640)
